...
class PConvUNet(nn.Module):
    def __init__(self, layer_size=7, input_channels=3, upsampling_mode='nearest'):
        ...
        # Reduce kernel sizes for smaller input images
        ...
        # Reduce number of layers for smaller input
        self.layer_size = 4  # Override layer_size to prevent over-downsampling
